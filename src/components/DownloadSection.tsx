          ...
          <div className="flex items-center gap-4 text-center md:text-left">
            ...
            <div>
              ...
              <p className="text-sm text-slate-600 dark:text-slate-300 font-medium">
                ...
                <strong className="text-slate-900 dark:text-white">{targetLangName}</strong>. You can download the file or inspect the translated text below. The PDF preserves the rendered text as images; use Copy Text below for selectable text.
              </p>
            </div>
          </div>
